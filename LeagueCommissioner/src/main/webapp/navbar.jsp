...
<div class="header hidden-md-down">
	<div class="header-container">
		...
		<ul>
			...
			<li><a href="http://localhost:8085/LeagueCommissioner/updateuser">Update Account</a></li>
		...
		<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
			...
			<c:choose>
				...
				<c:when test="${ sessionScope.user.getRole() == 3}">
					...
					<a class="dropdown-item" href="http://localhost:8085/LeagueCommissioner/createuser">Register Coach</a>
				</c:when>
				
				<c:when test="${ sessionScope.user.getRole() == 2}">
					<a class="dropdown-item" href="http://localhost:8085/LeagueCommissioner/stats">Stats</a>
					<a class="dropdown-item" href="http://localhost:8085/LeagueCommissioner/createuser">Register Player</a>
				</c:when>
			...
			<a class="dropdown-item" href="http://localhost:8085/LeagueCommissioner/updateuser">Update Account</a>
